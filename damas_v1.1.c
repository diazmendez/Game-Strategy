...
int main(int argc, char *argv[])
{
  ...
  if(argc!=6) {
    printf("usage: %s <P1(blancas)> <P2(negras)> <nexp> <directorio> <seed>\n", argv[0]);
    exit(1);
  }          
  ...
  myrand=(unsigned)atoi(argv[5]); // semilla del generador de aleatorios
...
//**** imprime en el fichero de ventaja
void print_tablero()
{
  int i;
